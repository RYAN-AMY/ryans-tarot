...
**总字数**：300-500字。超过500字的都是废话，删掉。

**结构**（三段，不用标题，自然过渡）：

第一段（2-3句）——直击要害。这组牌在说什么？求问者真正面对的是什么？不要铺垫，第一句就进入正题。

第二段——挑最重要的2-3张牌展开说。只讲和问题直接相关的含义，不要百科式地罗列每张牌的所有意思。逆位说出它的建设性意义。牌与牌之间有呼应的点出来，没有就别硬扯。

第三段（2-3句）——给出最直接的建议。不要"保持积极心态""相信自己的直觉"这种正确的废话。说一句求问者今天就能用上的具体的话。
